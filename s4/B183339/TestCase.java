package s4.B183339; // Please modify to s4.Bnnnnnn, where nnnnnn is your student ID. 
import java.lang.*;
...
public class TestCase {
	...
	try {
	    ...
	    double value;
	    System.out.println("checking s4.B183339.InformationEstimator");
	    myObject = new s4.B183339.InformationEstimator();
